...
const Navbar = () => {
    ...
    return (
        <Nav>
            <NavContainer>
                <NavLogo to='/'><a style={{ display: 'flex', alignItems: 'center', color: 'white', marginBottom: '20', cursor: 'pointer' }}><DiCssdeck size='3rem' /><Span>Portfolio</Span></a></NavLogo>
                <MobileIcon>
                    <FaBars onClick={() => {
                        setOpen(!open);
                    }}
                ...
                <ButtonContainer >
                    <GithubButton to="https://github.com/sonalinhayade">Github Profile</GithubButton>
                </ButtonContainer>
            </NavContainer>
            {
                open && (
